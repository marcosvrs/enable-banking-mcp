...
The [privacy policy](privacy-policy.md) and [terms of use](terms-of-use.md) are personal, noncommercial notices for this self-hosted deployment. They identify an individual operator rather than a company or hosted service. They are published for provider registration at the public GitHub URLs below; the operator must keep them accurate and review the separate provider terms and notices before using Production:

- Privacy: https://github.com/marcosvrs/enable-banking-mcp/blob/main/privacy-policy.md
- Terms: https://github.com/marcosvrs/enable-banking-mcp/blob/main/terms-of-use.md
